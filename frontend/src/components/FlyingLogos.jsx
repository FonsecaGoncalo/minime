...
// On-brand reveal palette — complements the warm orange gradient
const VIBRANT_PALETTE = [
    '#1c1815', // ink — strong dark contrast
    '#1e3447', // night blue — cool complement to orange
    '#152333', // deep navy
    '#f5e8d0', // cream — light highlight on darker gradient stops
    '#c0623e', // terracotta — on-palette warm
    '#b85a3a', // accent — deeper red-orange
];
